...

{
  ...
  "repository": {
    "type": "js",
    "url": "https://raw.githubusercontent.com/aanfauzicoding/Afc-Carousel/main/AFC-Carousel.js"
  },
  "keywords": [],
  "author": "aan fauzi",
  "license": "gitignore",
  "bugs": {
    "url": "https://github.com/aanfauzicoding/Afc-Carousel/blob/main/.gitignore"
  },
  "homepage": "https://github.com/aanfauzicoding/Afc-Carousel/blob/main/LICENSE"
}
```
